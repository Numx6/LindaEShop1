        ...
        var before = '<div class="square"><div class="numb">',
            ...
            if ($().countdown) {
                $(".countdown").countdown('2020/6/22', function(event) {
                  $(this).html(event.strftime(before + '%D' + text + 'روز</div></div>' + before + '%H' + text + 'ساعت</div></div>' + before + '%M' + text + 'دقیقه</div></div>' + before + '%S' + text + 'ثانیه</div>'));
                });
            }      
    };
        ...
        if( $().slider ) {
            $( function() {
                $( "#slide-range" ).slider({
                  ...
                  min: 1000,
                  max: 30000000,
                  values: [ 1000, 30000000 ],
                  slide: function( event, ui ) {
                    $( "#amount" ).val( ui.values[ 0 ] + " تومان" + " تا " + ui.values[ 1 ] + " تومان" );
                  }
                });
                $( "#amount" ).val( $( "#slide-range" ).slider( "values", 0 ) + " تومان" + " تا " + $( "#slide-range" ).slider( "values", 1 ) + " تومان" );
            });
        }
    };
